...
${OBJECTDIR}/DaThuc.o: DaThuc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DaThuc.o DaThuc.cpp
...
${OBJECTDIR}/Lich_Nam.o: Lich_Nam.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Lich_Nam.o Lich_Nam.cpp

${OBJECTDIR}/Ma_tran.o: Ma_tran.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Ma_tran.o Ma_tran.cpp

${OBJECTDIR}/NV.o: NV.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NV.o NV.cpp

${OBJECTDIR}/NhanVien.o: NhanVien.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NhanVien.o NhanVien.cpp

${OBJECTDIR}/PT_BacNhat_2An.o: PT_BacNhat_2An.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PT_BacNhat_2An.o PT_BacNhat_2An.cpp
...
${OBJECTDIR}/PhanSo.o: PhanSo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PhanSo.o PhanSo.cpp

${OBJECTDIR}/Point_TD.o: Point_TD.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Point_TD.o Point_TD.cpp

${OBJECTDIR}/QLSV.o: QLSV.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/QLSV.o QLSV.cpp

${OBJECTDIR}/SoNguyenTo.o: SoNguyenTo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SoNguyenTo.o SoNguyenTo.cpp

${OBJECTDIR}/SoPhuc.o: SoPhuc.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SoPhuc.o SoPhuc.cpp

${OBJECTDIR}/TamGiac.o: TamGiac.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TamGiac.o TamGiac.cpp

${OBJECTDIR}/ThiSinh.o: ThiSinh.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThiSinh.o ThiSinh.cpp
...
${OBJECTDIR}/ToaDo.o: ToaDo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ToaDo.o ToaDo.cpp

${OBJECTDIR}/Toa_Do.o: Toa_Do.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Toa_Do.o Toa_Do.cpp

${OBJECTDIR}/UCLN.o: UCLN.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UCLN.o UCLN.cpp
...
${OBJECTDIR}/VienPhi.o: VienPhi.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VienPhi.o VienPhi.cpp
